...
The `NemS/Diagonal/` library sharpens the diagonal barrier to an exact Turing-degree classification of record-truth: degree 0′ (many-one equivalent to the halting predicate), above total computation and strictly below hypercomputation. These results feed the transputation classification in the companion repo [transputation-lean](https://github.com/novaspivack/transputation-lean). See [MANIFEST.md](MANIFEST.md) for the full theorem inventory.
...
- **[transputation-lean](https://github.com/novaspivack/transputation-lean)** — Lean 4 formalization of the transputation classification theorems (Papers 76–77).
...
- **[Complete GTE Framework](https://doi.org/10.5281/zenodo.20560550)** — Paper 48: the UGP Physics synthesis monograph that connects to the NEMS self-reference arc.
