...
theorem soundness_capstone {Stratum : Type*} (cov : CovMap) (S : Stratum)
    (C : Formula) (h : Derivable cov (axFromCov cov) S C) :
  ...
  | union S C₁ C₂ _ _ ih1 ih2 =>
    ...
    have hcov1 : C₁ ⊆ protocolCoverage (canonicalRoleAssign cov) P₁ :=
      hC1.trans (protocolCoverage_eq_of_ConsistentWith cov R₁ hR1 P₁).ge
    have hcov2 : C₂ ⊆ protocolCoverage (canonicalRoleAssign cov) P₂ :=
