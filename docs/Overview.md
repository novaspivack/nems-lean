...
This document is for **outside parties** who want to use or build on the libraries (SelfReference, Closure, Reflection, SelectorStrength, Learning, EpistemicAgency, SelfImprovement, SelfAwareness, Sieve, Hypercomputation, ArrowOfTime, ChronologyUnderClosure, BlackHoles, GPTClosure, GPTClosure/Instances/QuantumFinite, InstitutionalEpistemics, CertificationLogic, SemanticSelfDescription, InternalitySchema, SurvivorCalculus, AdmissibleContinuation, ForcedAdjudication, StructuralNonExhaustibility, NemS) without reading the full papers first. It covers what each part is, how to import it, and how the pieces fit together.
...
- **Reflection** (Paper 28) adds stratified representability (SRI_R, DiagClosed); **SelectorStrength** (29) the barrier hierarchy; **Learning** (30) the self-certifier barrier; **EpistemicAgency** (31) society as verification protocol; **SelfImprovement** (32) upgrade-certifier barrier and society-improves-improvement; **SelfAwareness** (33) limits of self-awareness (hierarchy, selector necessity, rightness barrier); **Sieve** (34) meta-methodology kernel for theory spaces (constraints as list, residual subtype, monotonicity, pullback/functoriality). **Paper 35** (Oracles as External Selectors) applies Closure and SelectorStrength to hypercomputation; its Lean library (Hypercomputation/) is complete (0 sorry). **Paper 36** (The Arrow of Time from Closure) — ArrowOfTime (record filtration, refinement, no-overwrite, irreversibility, selection barrier); **Paper 37** (Chronology Under Closure) — ChronologyUnderClosure (record dynamics, selection barrier); **Paper 38** (Black Hole Information) — BlackHoles (record consistency, no-hypercomputing-from-BH); **Paper 39** (Probability as Closure in GPTs) — GPTClosure (state uniqueness under closure principles); **GPTClosure/Instances/QuantumFinite** bridges Paper 13 (NemS.Quantum) and Paper 39 (GPTClosure), showing finite-dimensional quantum probability is an instance of closure-forced probability: PSD cone → ordered unit space, Born rule = GPT pairing, POVMs → GPT measurements, state uniqueness via GPT uniqueness (3 documented sorrys; all structural definitions and Born-rule-equals-GPT-pairing theorem fully proved); **Paper 40** (Institutions Under Diagonal Constraints) — InstitutionalEpistemics (no universal final judge, k-role lower bound, diversity necessity). All have Lean libraries (0 sorry in core modules; QuantumFinite has 3 documented sorrys).
...
- **Paper 35:** *Oracles as External Selectors* — oracle-as-selector (Closure), no internal hypercomputer (SelectorStrength), hypercomputation taxonomy; Lean library Hypercomputation (0 sorry): no_internal_hypercomputer_at_strength, internal_hypercomputer_claim_forces_premise_failure, halting and record-truth instances.
- **Paper 36:** *The Arrow of Time from Closure* — record filtration, refinement, no_overwrite, irreversibility, selection_barrier_retrodiction; ArrowOfTime library (0 sorry).
- **Paper 37:** *Chronology Under Closure* — record dynamics, self-consistent loops, record_non_overwrite, selection_barrier_chronology; ChronologyUnderClosure library (0 sorry).
- **Paper 38:** *NEMS Constraints on Black Hole Information* — record fragments, record_consistency_abstract, no_hypercomputing_from_bh; BlackHoles library (0 sorry).
...
- **Paper 82:** *Determinacy Without Outsourcing* — synthesis paper; new modules in InternalitySchema (Foundationality: foundational_iff_internal_completion, Meta-Principle 2) and StructuralNonExhaustibility (InternalizationNotTotalization: internalization_not_totalization, Meta-Principle 3). Both 0 sorry.
